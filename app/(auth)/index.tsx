...
export default function AuthScreen() {
    ...
    return (
        <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" bottomOffset={40} className="bg-gray-100 dark:bg-black">
            <SafeAreaView className='flex-1 gap-10 px-6 pt-10'>
                ...
                <Text className='text-center font-bold text-4xl text-sky-800 dark:text-sky-400'>{isLogin ? 'Welcome back' : 'Create account'}</Text>

                <View className='flex-row p-1 rounded-full bg-zinc-200 dark:bg-zinc-800'>
